...
const props = defineProps({
  ...
  envPath: { type: String, required: false, default: undefined },
...
if (props.envPath !== undefined) {
  ...
  env = new THREE.Mesh(envGeometry, envMaterial)
}
...
<template>
  <TresGroup :position="props.position" ref="groupRef">
    <primitive v-if="env !== undefined" ref="envRef" :object="env" />
